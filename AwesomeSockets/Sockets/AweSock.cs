...
namespace AwesomeSockets.Sockets
{
    ...
    public class AweSock
    {
        ...
        {
            if (socket.GetSocket().ProtocolType == ProtocolType.Udp) throw new ConstraintException("Cannot call this method with a UDP socket. Call SendMessage(Socket, string, int, Buffer) instead.");
