...
namespace AwesomeSockets.Domain
{
    ...
    //TODO: Needs to be internal after all unit tests are appropriately written
...
//            if (typeof(T) == typeof(string)) return (T)(object)buffer.GetString();
            throw new DataException("Provided type ({0}) cannot be deserialized from given value. You must provide a (except struct and enum) or a string");
        }
